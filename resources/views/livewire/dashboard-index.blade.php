...
>
    <div class="min-h-screen bg-white/80 overflow-y-auto pb-32"> <div class="max-w-[1800px] mx-auto p-6 md:p-10">
        ...
        </div> </div> <div class="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-xl border border-gray-200/50 p-2 rounded-2xl shadow-2xl flex items-center gap-2 z-40 max-w-[90vw] overflow-x-auto">
        ...
        <button class="px-3 py-2 rounded-xl bg-gray-50 text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition">
